...
function ChatAgent(domain, role, oppRole, gameid,country) {
  ...
  console.log("ChatAgent", "default constractor");
...
ChatAgent.prototype = {
  ...
  //next bid to offer according to the A stuck
    ...
    //self.B_temp = {}; // when I suggest an offer I put into temp_b = B, so if the opp did not say anithing and i should offer the same thing again, the offer will not appear twice in temp_b.
    offerOut =[];
    self.turn = turn;
